...
workspace_name = "quick-starts-ws-138910" # PLACEHOLDER
subscription_id = "2c48c51c-bd47-40d4-abbe-fb8eabd19c8c" # PLACEHOLDER
resource_group = "aml-quickstarts-138910" # PLACEHOLDER
experiment_name = "capstone-automl-exp" # PLACEHOLDER
iteration = "38"  # PLACEHOLDER
run_id = "AutoML_7f9dbb7c-ee1a-4c6f-9e5c-ad5845f029c2_38"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'path':None,'name':'capstone-automl-exp','subscription_id':'2c48c51c-bd47-40d4-abbe-fb8eabd19c8c','resource_group':'aml-quickstarts-138910','workspace_name':'quick-starts-ws-138910','region':'southcentralus','compute_target':'cluster-automl','spark_service':None,'azure_service':'remote','many_models':False,'pipeline_fetch_max_batch_size':1,'iterations':1000,'primary_metric':'AUC_weighted','task_type':'classification','data_script':None,'validation_size':0.0,'n_cross_validations':None,'y_min':None,'y_max':None,'num_classes':None,'featurization':'auto','_ignore_package_version_incompatibilities':False,'is_timeseries':False,'max_cores_per_iteration':1,'max_concurrent_iterations':5,'iteration_timeout_minutes':None,'mem_in_mb':None,'enforce_time_on_windows':False,'experiment_timeout_minutes':20,'experiment_exit_score':None,'whitelist_models':None,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'supported_models':['MultinomialNaiveBayes','XGBoostClassifier','LogisticRegression','LinearSVM','KNN','ExtremeRandomTrees','DecisionTree','AveragedPerceptronClassifier','LightGBM','GradientBoosting','RandomForest','SVM','BernoulliNaiveBayes','SGD','TensorFlowDNN','TensorFlowLinearClassifier'],'auto_blacklist':True,'blacklist_samples_reached':False,'exclude_nan_labels':True,'verbosity':20,'_debug_log':'azureml_automl.log','show_warnings':False,'model_explainability':True,'service_url':None,'sdk_url':None,'sdk_packages':None,'enable_onnx_compatible_models':True,'enable_split_onnx_featurizer_estimator_models':False,'vm_type':'STANDARD_D2_V2','telemetry_verbosity':20,'send_telemetry':True,'enable_dnn':False,'scenario':'SDK-1.13.0','environment_label':None,'force_text_dnn':False,'enable_feature_sweeping':False,'enable_early_stopping':True,'early_stopping_n_iters':10,'metrics':None,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_tf':False,'enable_subsampling':None,'subsample_seed':None,'enable_nimbusml':False,'enable_streaming':False,'force_streaming':False,'track_child_runs':True,'allowed_private_models':[],'label_column_name':'target','weight_column_name':None,'cv_split_column_names':None,'enable_local_managed':False,'_local_managed_run_id':None,'cost_mode':1,'lag_length':0,'metric_operation':'maximize','preprocess':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'AUC_weighted','verbosity':20,'ensemble_iterations':15,'is_timeseries':False,'name':'capstone-automl-exp','compute_target':'cluster-automl','subscription_id':'2c48c51c-bd47-40d4-abbe-fb8eabd19c8c','region':'southcentralus','spark_service':None}\",\"ensemble_run_id\":\"AutoML_7f9dbb7c-ee1a-4c6f-9e5c-ad5845f029c2_38\",\"experiment_name\":\"capstone-automl-exp\",\"workspace_name\":\"quick-starts-ws-138910\",\"subscription_id\":\"2c48c51c-bd47-40d4-abbe-fb8eabd19c8c\",\"resource_group_name\":\"aml-quickstarts-138910\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"training_data\": \"{\\\"blocks\\\": [{\\\"id\\\": \\\"b28391f2-0519-40e2-8f17-8f0e2e9af0b2\\\", \\\"type\\\": \\\"Microsoft.DPrep.GetFilesBlock\\\", \\\"arguments\\\": {\\\"isArchive\\\": false, \\\"path\\\": {\\\"target\\\": 4, \\\"resourceDetails\\\": [{\\\"path\\\": \\\"https://raw.githubusercontent.com/Daniel-car1/nd00333-capstone/main/heart.csv\\\"}]}}, \\\"localData\\\": {}, \\\"isEnabled\\\": true, \\\"name\\\": null, \\\"annotation\\\": null}, {\\\"id\\\": \\\"00f10ab2-8b2f-4ab5-8e1b-41e818394367\\\", \\\"type\\\": \\\"Microsoft.DPrep.ParseDelimitedBlock\\\", \\\"arguments\\\": {\\\"columnHeadersMode\\\": 3, \\\"fileEncoding\\\": 0, \\\"handleQuotedLineBreaks\\\": false, \\\"preview\\\": false, \\\"separator\\\": \\\",\\\", \\\"skipRows\\\": 0, \\\"skipRowsMode\\\": 0}, \\\"localData\\\": {}, \\\"isEnabled\\\": true, \\\"name\\\": null, \\\"annotation\\\": null}, {\\\"id\\\": \\\"abbe51be-11dd-4721-bab2-6f1e38c9c6c7\\\", \\\"type\\\": \\\"Microsoft.DPrep.DropColumnsBlock\\\", \\\"arguments\\\": {\\\"columns\\\": {\\\"type\\\": 0, \\\"details\\\": {\\\"selectedColumns\\\": [\\\"Path\\\"]}}}, \\\"localData\\\": {}, \\\"isEnabled\\\": true, \\\"name\\\": null, \\\"annotation\\\": null}, {\\\"id\\\": \\\"e7571c05-afa4-4a49-89f8-d45caea4b702\\\", \\\"type\\\": \\\"Microsoft.DPrep.SetColumnTypesBlock\\\", \\\"arguments\\\": {\\\"columnConversion\\\": [{\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"age\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"sex\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"cp\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"trestbps\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"chol\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"fbs\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"restecg\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"thalach\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"exang\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"oldpeak\\\"}}, \\\"typeProperty\\\": 3}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"slope\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"ca\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"thal\\\"}}, \\\"typeProperty\\\": 2}, {\\\"column\\\": {\\\"type\\\": 2, \\\"details\\\": {\\\"selectedColumn\\\": \\\"target\\\"}}, \\\"typeProperty\\\": 2}]}, \\\"localData\\\": {}, \\\"isEnabled\\\": true, \\\"name\\\": null, \\\"annotation\\\": null}], \\\"inspectors\\\": [], \\\"meta\\\": {\\\"savedDatasetId\\\": \\\"a7a6f492-78a2-419f-b77e-2399d3fdca9a\\\", \\\"datasetType\\\": \\\"tabular\\\", \\\"subscriptionId\\\": \\\"2c48c51c-bd47-40d4-abbe-fb8eabd19c8c\\\", \\\"workspaceId\\\": \\\"a3c3fc62-632a-4397-92c7-fde30337bd22\\\", \\\"workspaceLocation\\\": \\\"southcentralus\\\"}}\", \"activities\": 0}" # PLACEHOLDER
